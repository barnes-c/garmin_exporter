module github.com/barnes-c/garmin_exporter

go 1.26.4

require (
	github.com/alecthomas/kingpin/v2 v2.4.0
	github.com/barnes-c/go-garminconnect v0.1.6
...
require (
	...
	go.opentelemetry.io/contrib/samplers/probability/consistent v0.37.1 // indirect
